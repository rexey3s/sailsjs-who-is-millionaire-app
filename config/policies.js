...
module.exports.policies = {
  ...
  'player': {
    ...
    'showroom': ['isAuthenticated'],
    'join': 'isAuthenticated',
    'disjoin':'isAuthenticated',
    'logout': 'isAuthenticated',
    'start1quiz': ['isAuthenticated'],
    'mainplayer': ['isAuthenticated'],
    'audience' : ['isAuthenticated'],
    'nextquiz' : 'isAuthenticated',
    '5050' :'isAuthenticated',
    'scoreboard':'isAuthenticated',
    'audience_support':'isAuthenticated',
    'relative':'isAuthenticated',
    'quit': 'isAuthenticated'
  },
  'room' : {
    'index' : ['admin','flash'],
  	'new': 'admin',
